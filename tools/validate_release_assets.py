"""Static release-asset validation for the TiRex-2 forecasting DIMER pipeline.
...
EXPECTED_MODEL_ID = "NX-AI/TiRex-2"
...
EXPECTED_OUTPUTS = (
    "outputs/tirex_forecasting_input_manifest.json",
    "outputs/tirex_forecasting_evaluation_report.json",
    "outputs/tirex_forecasting_result.json",
    "outputs/tirex_forecasting_forecast.csv",
)
...
MARKDOWN_MARKERS = (
    ...
    "`sample-sanity`",
    "gradient training or fine-tuning, streaming/online adaptation, classification or regression",
)
