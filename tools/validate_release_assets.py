...
EXPECTED_OUTPUTS = ('outputs/tirex_forecast.csv', 'outputs/tirex_provenance.json')
...
CODE_MARKERS = (
    ...
    'from tirex_forecasting_pipeline import TiRexForecastPipeline, last_value_baseline, mae, rmse,',
